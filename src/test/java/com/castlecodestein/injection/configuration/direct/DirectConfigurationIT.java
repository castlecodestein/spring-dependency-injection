...
import com.castlecodestein.injection.configuration.direct.SpringDirectBeanConfiguration;
...
@ContextConfiguration(classes = SpringDirectBeanConfiguration.class, loader = AnnotationConfigContextLoader.class)
@DirtiesContext(classMode = ClassMode.AFTER_EACH_TEST_METHOD)
public class DirectConfigurationIT {
