...
import com.castlecodestein.injection.configuration.imported.SpringTopConfiguration;
import com.castlecodestein.injection.post.Post;
import com.castlecodestein.injection.post.PostApi;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = SpringTopConfiguration.class, loader = AnnotationConfigContextLoader.class)
@DirtiesContext(classMode = ClassMode.AFTER_EACH_TEST_METHOD)
public class ImportedConfigurationIT {
