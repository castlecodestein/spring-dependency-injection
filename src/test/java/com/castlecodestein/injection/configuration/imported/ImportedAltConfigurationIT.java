...
import com.castlecodestein.injection.configuration.imported.SpringTopAltConfiguration;
import com.castlecodestein.injection.post.Post;
import com.castlecodestein.injection.post.PostApi;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = SpringTopAltConfiguration.class, loader = AnnotationConfigContextLoader.class)
@DirtiesContext(classMode = ClassMode.AFTER_EACH_TEST_METHOD)
public class ImportedAltConfigurationIT {
